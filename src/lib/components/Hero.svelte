<script lang="ts">
  ...
  onMount(() => {
    mounted = true;
    setTimeout(() => typeText(introText, v => displayIntro = v, 18), 300);
...
<section id="hero">
  <div class="hero-content" class:visible={mounted}>
    ...
    <div class="hero-socials">
      ...
      <a href="https://linkedin.com" target="_blank" rel="noreferrer" class="social-link" aria-label="LinkedIn">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <a href="mailto:hello@ndifrekeudoh.dev" class="social-link" aria-label="Email">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<style>
  ...
  .hero-visual { transition-delay: 0.15s; }
  .hero-content.visible, .hero-visual.visible {
  ...
  .btn-ghost {
    ...
    text-transform: uppercase; padding: 0.85rem 2rem;
    border-radius: 2rem; border: 1px solid var(--border-strong);
